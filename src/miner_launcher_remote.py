...
def auto_miner_launcher_remote(bt_endpoint, server_name):
    ...
    all_processed = True  # Assume all processes will be processed
    ...
    if all_processed:
        logging.info("All sniper processes have been processed. Exiting.")
        return  # Exit the function if all processes are processed
    else:
